            ...
            <Container>
                ...
                <Navbar.Collapse id="responsive-navbar-nav">
                    <Nav className="ms-auto">
                        ...
                        <Nav.Link className='me-5 text-white' id='navlink' href="jithint_cv.pdf" download={"jithint_cv.pdf"}><i className="fa-solid fa-download me-1"></i>Download CV</Nav.Link>
                    </Nav>
                </Navbar.Collapse>
            </Container>
        </Navbar>
